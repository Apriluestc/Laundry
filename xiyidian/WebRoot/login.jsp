...
<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
	  <TR>
	       ...
	       <div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 35pt;"><font color="black">洗衣店管理系统</font></div></TD>
	  </TR>
	  <TR>
		          ...
		          <TD>
		            <TABLE cellSpacing=0 cellPadding=2 border=0>
			              <TR>
			                ...
			                <TD style="HEIGHT: 28px" width=370><font style="font-size: 11px;"></font></TD>
			              </TR>
			              <TR>
			              ...
			              <TR>
			                <TD style="HEIGHT: 18px">权限：</TD>
			                <TD style="HEIGHT: 18px">
			                	<select class="radius3" name="userType" style="width:130px;height:25px">
								    <option value="-1" selected="selected">请选择登陆身份</option>
									<option value="0">管理员</option>
									<option value="1">会&nbsp;&nbsp;&nbsp;员</option>
								</select>
			                </TD>
