...
<jsp:directive.page import="com.model.TShou"/>
<%@ taglib prefix="s" uri="/struts-tags"%>
<%
    String path = request.getContextPath();
    float kk=0.0f;
    List shouList=(List)request.getAttribute("shouList");
    for(int i=0;i<shouList.size();i++)
    {
        TShou shou=(TShou)shouList.get(i);
        kk+=shou.getJiage();
    }
%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="14" background="<%=path %>/images/tbg.gif">&nbsp;洗衣业务统计&nbsp;</td>
				</tr>
				...
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="53" align="center" style="color: red">&nbsp;总金额：<%=kk %>&nbsp;</td>
				</tr>
			</table>
	</body>
</html>
