...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
            function StringBuffer()//是一个可变对象，=new StringBuffer
            { 
            ...
            function queding()
            {
                 ...
                 var object=document.getElementsByName("userId");//返回的obeject是数组
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="100" background="<%=path %>/images/tbg.gif">&nbsp;洗衣类型信息&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<s:property value="#user.userKahao"/>
					</td>
					<td bgcolor="#FFFFFF" align="center">
					    <s:property value="#user.userYue"/>
					</td>
					<td bgcolor="#FFFFFF" align="center">
						<input type="radio" name="userId" value="<s:property value="#user.userId"/>"/>
					</td>
				</tr>
				</s:iterator>
			</table>
